...
function getCommonHeaders() {
  ...
  [curTeamDataOne.value, curTeamDataTwo.value, curTeamDataThree.value].filter(x => x != null && !x.noData).forEach(teamData => {
...
function fillMissingHeaders(commonHeaders, teamData) {
  if (teamData["noData"]) {
...
<template>
  <div class="vueContainer">
    ...
    <h1 class="sectionTitle">Match Search</h1>
